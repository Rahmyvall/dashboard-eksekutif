...
@section('content')
     ...
     <div class="position-form-page">
          <div class="position-form-container">
                    ...
                    <div class="position-form-hero-content">
                         <div class="position-form-title-wrap">
                              ...
                              <div>
                                   ...
                                   <p>
                                        Tambahkan jabatan ke dalam struktur organisasi dan hubungkan
               ...
               <form method="POST" class="w-100" action="{{ route('super-admin.positions.store') }}" autocomplete="off">
                    @csrf
                         ...
                         <div class="position-form-card-body">
                                        ...
                                        <div class="col-12 col-md-6">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="text" id="code" name="code" maxlength="30"
                                                       ...
                                                       placeholder="Contoh: MGR-CS" required>
                                             </div>

                                             <small class="position-help">
                                                  Gunakan huruf kapital, angka, tanda hubung, atau garis bawah.
                                             </small>
                                        ...
                                        <div class="col-12 col-md-8">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="text" id="name" name="name" maxlength="150"
                                                       ...
                                                       placeholder="Contoh: Manager Customer Service" required>
                                             </div>
                                        ...
                                        <div class="col-12 col-md-4">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="number" id="level" name="level" min="1"
                                                       max="65535" value="{{ old('level', 1) }}"
                                                       class="form-control position-control @error('level') is-invalid @enderror"
                                                       placeholder="1" required>
                                             </div>

                                             <small class="position-help">
                                                  Semakin tinggi angka, semakin tinggi tingkat jabatan.
                                             </small>
                              ...
                              <div class="position-section">
                                   ...
                                   <textarea id="description" name="description"
                                        ...
                                        placeholder="Tuliskan tanggung jawab atau gambaran singkat jabatan...">{{ old('description') }}</textarea>
                              ...
                              <div class="position-section">
                                   ...
                                   @php
                                        $selectedStatus = old('status', \App\Models\Position::STATUS_ACTIVE);
                                   @endphp
