...
@section('content')
     ...
     @php
          ...
          $statusConfig = [
              ...
              'completed' => [
                  'label' => 'Selesai',
                  'description' => 'Proses penilaian telah ditutup.',
                  'icon' => 'bi-flag-fill',
              ],
              'inactive' => [
                  'label' => 'Tidak Aktif',
          ...
          <div class="pp-container">
               <div class="pp-hero">
                    <div>
                         ...
                         <h1>Edit Periode Penilaian</h1>

                         <p>
                              Perbarui data periode <strong>{{ $performancePeriod->name }}</strong>
                              sesuai struktur tabel <strong>performance_periods</strong>.
                         </p>
                    </div>

                    <a href="{{ route('super-admin.performance-periods.show', $performancePeriod) }}" class="pp-back">
               ...
               <div class="row g-4">
                    <div class="col-xl-8">
                         <form method="POST"
                              action="{{ route('super-admin.performance-periods.update', $performancePeriod) }}"
                              class="pp-card pp-form" id="performancePeriodEditForm">
                              @csrf
                              @method('PUT')
                              ...
                              <div class="pp-card-header">
                                   ...
                                   <div>
                                        <h4>Form Edit Periode Penilaian</h4>
                                        <p>Periksa kembali setiap nilai sebelum menyimpan perubahan.</p>
                                   </div>
                              </div>
                              ...
                              <div class="pp-card-body">
                                   <div class="pp-section">
                                        <div class="pp-section-title">
                                             ...
                                             <div>
                                                  ...
                                                  <small>Nama periode yang mudah dikenali.</small>
                                             </div>
                                        </div>
                                        ...
                                        <div class="pp-field">
                                             ...
                                             <input type="text" id="name" name="name" maxlength="255"
                                                  value="{{ old('name', $performancePeriod->name) }}"
                                             ...
                                             <div class="col-md-6">
                                                  ...
                                                  <div class="pp-field">
                                                       ...
                                                       <input type="date" id="start_date" name="start_date"
                                                            value="{{ old('start_date', optional($performancePeriod->start_date)->format('Y-m-d')) }}"
                                             ...
                                             <div class="col-md-6">
                                                  ...
                                                  <div class="pp-field">
                                                       ...
                                                       <input type="date" id="end_date" name="end_date"
                                                            value="{{ old('end_date', optional($performancePeriod->end_date)->format('Y-m-d')) }}"
                                   ...
                                   <div class="pp-section">
                                        <div class="pp-section-title">
                                             ...
                                             <div>
                                                  <h5>Jenis Periode</h5>
                                                  <small>Pilih pola periode penilaian.</small>
                                             </div>
                                        </div>
                                        ...
                                        <div class="pp-field">
                                             ...
                                             <select id="period_type" name="period_type"
                                                  ...
                                                  @foreach ($availablePeriodTypes as $type)
                                                       <option value="{{ $type }}" @selected(old('period_type', $performancePeriod->period_type) === (string) $type)>
                                   ...
                                   <div class="pp-section">
                                        <div class="pp-section-title">
                                             ...
                                             <div>
                                                  ...
                                                  <small>Tentukan kondisi periode setelah diperbarui.</small>
                                             </div>
                                        </div>
                                             ...
                                             @foreach ($availableStatuses as $status)
                                                  ...
                                                  <div class="pp-status-item">
                                                       <input type="radio" id="status_{{ $status }}" name="status"
                                                            value="{{ $status }}" @checked(old('status', $performancePeriod->status) === (string) $status)
                                                            required>
                              ...
                              <div class="pp-actions">
                                   <small class="text-secondary">
                                        ...
                                        Terakhir diperbarui:
                                        {{ optional($performancePeriod->updated_at)->format('d M Y H:i') ?? '-' }}
                                   </small>
                                   ...
                                   <div class="pp-info-body">
                                        ...
                                        <div class="pp-db-list">
                                             <div class="pp-db-item">
                                                  <strong>ID</strong>
                                                  <small>{{ $performancePeriod->id }}</small>
                                             </div>

                                             <div class="pp-db-item">
                                                  <strong>Nama</strong>
                                                  <small>{{ $performancePeriod->name }}</small>
                                             </div>

                                             <div class="pp-db-item">
                                                  <strong>Jenis</strong>
                                                  <small>{{ $periodTypeLabels[$performancePeriod->period_type] ?? $performancePeriod->period_type }}</small>
                                             </div>

                                             <div class="pp-db-item">
                                                  <strong>Status</strong>
                                                  <small>{{ $statusConfig[$performancePeriod->status]['label'] ?? $performancePeriod->status }}</small>
                                             </div>
                                        </div>
                                   </div>
                              </div>
                                   ...
                                   <div class="pp-info-body">
                                        <div class="alert alert-warning mb-0">
                                             ...
                                             <p class="mb-0 mt-1 small">
                                                  Perubahan tanggal atau status dapat memengaruhi
                                                  proses penilaian yang terhubung dengan periode ini.
                                             </p>
                                        </div>
                                   </div>
                              </div>
     ...
     @push('scripts')
          <script>
               document.addEventListener('DOMContentLoaded', function() {
                    const form = document.getElementById('performancePeriodEditForm');
