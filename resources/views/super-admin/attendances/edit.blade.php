     ...
     <div class="attf-page">
          <div class="attf-wrap">
               <section class="attf-hero">
                    ...
                    <a href="{{ route('super-admin.attendances.show', $attendance) }}" class="attf-icon-btn"
                         aria-label="Kembali ke Detail" title="Kembali ke Detail">
               ...
               <section class="card attf-card">
                    <div class="card-body p-4">
                         <form action="{{ route('super-admin.attendances.update', $attendance) }}" method="POST">
                              @csrf
                              @method('PUT')
                              ...
                              <div class="mt-4 d-flex gap-2 justify-content-end">
                                   <a href="{{ route('super-admin.attendances.show', $attendance) }}"
                                        class="btn btn-outline-secondary" aria-label="Batal" title="Batal">
                                        <i data-feather="x"></i>
                                   </a>

                                   <button type="submit" class="btn btn-warning" aria-label="Perbarui" title="Perbarui">
