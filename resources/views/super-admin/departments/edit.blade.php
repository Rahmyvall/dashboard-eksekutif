          ...
          <div class="department-container">
                    ...
                    <div class="row align-items-center">
                         <div class="col-lg-8">
                              <div class="hero-content">
                                   ...
                                   <h1 class="hero-title">Edit Department</h1>

                                   <p class="hero-description">
                                        Perbarui kode, nama, deskripsi, dan status department tanpa mengubah struktur
                                        database aplikasi.
                                   </p>
                              </div>
                         </div>
               ...
               @if ($errors->any())
                    <div class="department-alert" role="alert">
                         ...
                         <div>
                              <h6>Perubahan belum dapat disimpan</h6>
                              <ul>
               ...
               <div class="row g-4">
                    {{-- Main form --}}
                    <div class="col-xl-8">
                         <form method="POST" action="{{ route('super-admin.departments.update', $department) }}"
                              ...
                              <div class="department-card-header">
                                   ...
                                   <div>
                                        ...
                                        <p>Periksa kembali seluruh perubahan sebelum memperbarui data.</p>
                                   </div>
                              </div>
                                        ...
                                        <div class="status-options">
                                             <div class="status-option">
                                                  <input type="radio" id="status_active" name="status" value="active"
                                                       @checked(old('status', $department->status) === 'active')>
                                             ...
                                             <div class="status-option">
                                                  <input type="radio" id="status_inactive" name="status" value="inactive"
                                                       @checked(old('status', $department->status) === 'inactive')>
                                   ...
                                   <div class="form-section description-section">
                                        ...
                                        <div class="field-shell field-shell-textarea">
                                             ...
                                             <textarea id="description" name="description" rows="5"
                                                  ...
                                                  placeholder="Tuliskan tugas, fungsi, atau keterangan department...">{{ old('description', $department->description) }}</textarea>
                                        </div>
                              ...
                              <div class="form-actions">
                                   <div class="form-actions-note">
                                        ...
                                        <span>Kode boleh tetap sama selama bukan milik department lain.</span>
                                   </div>
                                   ...
                                   <div class="info-card-body">
                                        ...
                                        <ul class="guide-list">
                                             <li class="guide-item">
                                                  ...
                                                  <div>
                                                       <strong>Kode tetap harus unik</strong>
                                                       <p>Kode saat ini boleh dipertahankan atau diganti dengan kode lain
                                                            yang belum digunakan.</p>
                                                  </div>
                                             </li>
                                             ...
                                             <li class="guide-item">
                                                  ...
                                                  <div>
                                                       <strong>Periksa nama department</strong>
                                                       <p>Gunakan nama lengkap dan konsisten agar mudah ditemukan oleh
                                                            pengguna.</p>
                                                  </div>
                                             </li>
                                             ...
                                             <li class="guide-item">
                                                  ...
                                                  <div>
                                                       <strong>Status dapat diperbarui</strong>
                                                       <p>Department inactive tetap tersimpan dan dapat diaktifkan kembali
                                                            kapan saja.</p>
                                                  </div>
                                             </li>
                                        </ul>
                                        ...
                                        <div class="database-fields">
                                             <div class="database-field">
                                                  ...
                                                  <div>
                                                       ...
                                                       <small>Kode department saat ini</small>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="database-field">
                                                  ...
                                                  <div>
                                                       ...
                                                       <small>Nama department saat ini</small>
                                                  </div>
                                             </div>
                                             ...
                                             <div class="database-field">
                                                  ...
                                                  <div>
                                                       <strong>{{ $department->status_label }}</strong>
                                                       <small>Status department saat ini</small>
                                                  </div>
                                             </div>

                                             <div class="database-field">
                                                  <span class="database-field-icon"><i
                                                            class="bi bi-clock-history"></i></span>
                                                  <div>
                                                       <strong>{{ $department->updated_at ? $department->updated_at->format('d M Y, H:i') : '-' }}</strong>
                              ...
                              <div class="info-card">
                                   ...
                                   <div class="info-card-body">
                                        <div class="status-info">
                                             ...
                                             <p>
                                                  Perubahan akan langsung disimpan pada record department ini. Jika data
                                                  dihapus, sistem tetap menggunakan <b>soft delete</b>.
                                             </p>
                                        </div>
                                   </div>
                              </div>
