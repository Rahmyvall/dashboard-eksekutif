...
@section('content')
     ...
     <div class="position-form-page">
          <div class="position-form-container">
                    ...
                    <div class="position-form-hero-content">
                         <div class="position-form-title-wrap">
                              ...
                              <div>
                                   ...
                                   <p>
                                        Perbarui jadwal kerja, jam masuk, jam pulang, toleransi
                                        keterlambatan, total jam kerja, dan status penggunaannya.
                                   </p>
                              </div>
                         </div>

                         <a href="{{ route('super-admin.work-schedules.index') }}" class="position-back-link">
               ...
               <form method="POST" class="w-100" action="{{ route('super-admin.work-schedules.update', $workSchedule) }}"
                    autocomplete="off">
                    @csrf
                    @method('PUT')
                    ...
                    <section class="position-form-card">
                         <header class="position-form-card-header">
                              <h2 class="position-form-card-title">
                                   ...
                                   <span>Perbarui Informasi Jadwal Kerja</span>
                              </h2>

                              <p class="position-form-card-subtitle">
                                   Perbarui data yang diperlukan. Kolom bertanda bintang wajib diisi.
                              </p>
                         </header>
                         ...
                         <div class="position-form-card-body">
                                        ...
                                        <div class="col-12 col-md-6">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="time" id="start_time" name="start_time" step="60"
                                                       value="{{ old('start_time', $formatScheduleTime($workSchedule->start_time)) }}"
                                                       class="form-control position-control @error('start_time') is-invalid @enderror"
                                                       required>
                                             </div>
                                        ...
                                        <div class="col-12 col-md-6">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="time" id="end_time" name="end_time" step="60"
                                                       value="{{ old('end_time', $formatScheduleTime($workSchedule->end_time)) }}"
                                                       class="form-control position-control @error('end_time') is-invalid @enderror"
                                                       required>
                                             </div>
                                   ...
                                   <div class="row g-3">
                                        <div class="col-12">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="number" id="late_tolerance_minutes"
                                                       name="late_tolerance_minutes" min="0" max="65535"
                                                       step="1"
                                                       value="{{ old('late_tolerance_minutes', $workSchedule->late_tolerance_minutes) }}"
                                        ...
                                        <div class="col-12">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="number" id="working_hours" name="working_hours"
                                                       ...
                                                       value="{{ old('working_hours', $workSchedule->working_hours) }}"
                              ...
                              <div class="position-section">
                                   ...
                                   @php
                                        $selectedStatus = old('status', $workSchedule->status);
                                   @endphp
                                   ...
                                   <div class="position-status-options">
                                        <div class="position-status-option">
                                             <input type="radio" id="status-active" name="status" value="active"
                                                  @checked($selectedStatus === 'active') required>

                                             <label for="status-active"
                                                  class="position-status-label position-status-active">
                         ...
                         <footer class="position-form-footer">
                              ...
                              <button type="submit" class="position-btn position-btn-primary">
                                   ...
                                   <span>Perbarui Jadwal Kerja</span>
                              </button>
                         </footer>
                    </section>
               </form>
     ...
     @once
          <script>
               document.addEventListener('DOMContentLoaded', function() {
                    const lateToleranceInput = document.getElementById('late_tolerance_minutes');
