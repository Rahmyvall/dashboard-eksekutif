...
@section('content')
     ...
     <div class="position-form-page">
          <div class="position-form-container">
               <section class="position-form-hero">
                    <div class="position-form-hero-content">
                         <div class="position-form-title-wrap">
                              ...
                              <div>
                                   <h1>Tambah Jadwal Kerja Baru</h1>
                                   <p>
                                        Tambahkan jadwal kerja beserta jam masuk, jam pulang,
                                        toleransi keterlambatan, dan total jam kerja.
                                   </p>
                              </div>
                         </div>
               ...
               <form method="POST" class="w-100" action="{{ route('super-admin.work-schedules.store') }}"
                    autocomplete="off">
                    @csrf
                                        ...
                                        <div class="col-12">
                                             ...
                                             <div class="position-input-shell">
                                                  ...
                                                  <input type="number" id="late_tolerance_minutes"
                                                       ...
                                                       step="1" value="{{ old('late_tolerance_minutes', 0) }}"
