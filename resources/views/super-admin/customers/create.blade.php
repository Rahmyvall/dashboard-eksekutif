...
@section('content')
     @php
          ...
          $selectedType = old('customer_type', \App\Models\Customer::TYPE_INDIVIDUAL);
     @endphp
     ...
     <div class="customer-form-page">
          <div class="customer-shell">
               <section class="customer-page-hero">
                    <div class="customer-page-heading">
                         ...
                         <div>
                              ...
                              <p>
                                   Lengkapi identitas, kontak, alamat, dan status pelanggan.
                                   Kolom nama perusahaan wajib diisi ketika jenis pelanggan adalah perusahaan.
                              </p>
                         </div>
                    </div>
               ...
               <form method="POST" action="{{ route('super-admin.customers.store') }}" id="customer-form" novalidate>
                    @csrf
                         ...
                         <header class="customer-card-header">
                              <div>
                                   ...
                                   <p class="customer-card-subtitle">
                                        Informasi utama untuk membedakan setiap pelanggan.
                                   </p>
                              </div>
                         </header>
                              ...
                              <div class="row g-4">
                                   <div class="col-12 col-lg-4">
                                        ...
                                        <div class="customer-input-shell">
                                             ...
                                             <input type="text" id="customer_code" name="customer_code"
                                                  value="{{ old('customer_code') }}" maxlength="50"
                                                  class="form-control customer-form-control @error('customer_code') is-invalid @enderror"
                                                  placeholder="CUST-0001" autocomplete="off" required>
                                        </div>
                                        ...
                                        <div class="customer-input-shell">
                                             ...
                                             <select id="status" name="status"
                                                  ...
                                                  @foreach ($statusOptions as $value => $label)
                                                       <option value="{{ $value }}" @selected(old('status', \App\Models\Customer::STATUS_ACTIVE) === (string) $value)>
                                                            {{ $label }}
                                                       </option>
                                                  @endforeach
                                             </select>
                                   ...
                                   <div class="col-12 col-lg-6" id="company-name-wrapper">
                                        ...
                                        <div class="customer-help">
                                             Wajib untuk pelanggan perusahaan dan dikosongkan untuk pelanggan perorangan.
                                        </div>
                    ...
                    <section class="customer-card">
                         <header class="customer-card-header">
                              <div>
                                   ...
                                   <p class="customer-card-subtitle">
                                        Data komunikasi, alamat, dan identitas pajak pelanggan.
                                   </p>
                              </div>
                         </header>
                                   ...
                                   <div class="col-12 col-lg-6">
                                        ...
                                        <div class="customer-input-shell">
                                             ...
                                             <input type="text" id="tax_number" name="tax_number"
                                                  value="{{ old('tax_number') }}" maxlength="100"
                                                  class="form-control customer-form-control @error('tax_number') is-invalid @enderror"
                                                  placeholder="Masukkan nomor pajak bila tersedia">
                                        </div>
