     ...
     <div class="lrf-page">
          <div class="lrf-wrap">
               <div class="lrf-hero">
                    ...
                    <a href="{{ route($backRoute) }}" class="lrf-back" title="Kembali" aria-label="Kembali">
               ...
               <form method="POST" action="{{ route('leave-requests.store') }}" enctype="multipart/form-data"
                    ...
                    <div class="mt-4">
                         <button type="submit" class="lrf-submit" title="Simpan Pengajuan" aria-label="Simpan Pengajuan">
