...
class UpdatePositionRequest extends FormRequest
{
    ...
    /**
     * Menentukan apakah pengguna boleh memperbarui posisi.
     */
    ...
    /**
     * Aturan validasi pembaruan posisi.
     *
     * @return array<string, mixed>
     */
    public function rules(): array
    {
        $position = $this->getPositionFromRoute();
        ...
        return [
            ...
            'code'          => [
                ...
                /*
                 * Abaikan kode milik posisi yang sedang diperbarui.
                 */
    ...
    /**
     * Mengambil model Position dari parameter route.
     *
     * Route resource harus menggunakan parameter {position}.
     */
    private function getPositionFromRoute(): Position
    {
        $position = $this->route('position');

        /*
         * Jika implicit route model binding aktif,
         * Laravel langsung memberikan object Position.
         */
        ...
        /*
         * Cadangan apabila route masih mengirimkan ID.
         */
        return Position::query()->findOrFail($position);
    }
