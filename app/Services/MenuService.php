        ...
        [
            ...
            'children' => [
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'hr', 'manager_departemen', 'auditor', 'auditor_internal'],
                ],
                [
                    'label' => 'Data Jabatan',
                    'url' => 'positions',
                ...
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'hr', 'manager_departemen', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                [
                ...
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'admin_pelayanan', 'admin_operasional', 'finance', 'auditor', 'auditor_internal'],
                ],
                [
                    ...
                    'roles' => ['super_admin', 'admin_pelayanan', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                [
                    'label' => 'Data Layanan',
                    'url' => 'services',
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'manager_departemen', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                [
                    ...
                    'roles' => ['super_admin', 'manager_departemen', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                [
                ...
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'admin_pelayanan', 'admin_operasional', 'auditor', 'auditor_internal'],
                ],
                // For Karyawan only
                [
        ...
        [
            ...
            'children' => [
                [
                    ...
                    'permission' => 'attendances.view',
                    'roles' => ['super_admin', 'hr', 'manager_departemen', 'auditor', 'auditor_internal'],
                ],
                [
        ...
        [
            ...
            'children' => [
                [
                    ...
                    'roles' => ['super_admin', 'admin_operasional', 'finance', 'auditor', 'auditor_internal'],
                ],
                [
                    'label' => '9. Invoice',
                    'url' => 'invoices',
                    ...
                    'permission' => 'invoices.view',
                    'roles' => ['super_admin', 'executive', 'admin_pelayanan', 'finance', 'auditor', 'auditor_internal'],
                ],
                [
                    'label' => '10. Pembayaran',
                    'url' => 'payments',
                    ...
                    'roles' => ['super_admin', 'executive', 'finance', 'auditor', 'auditor_internal'],
                ],
            ],
        ],
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'roles' => ['super_admin', 'hr', 'auditor', 'auditor_internal'],
                ],
                [
                    ...
                    'roles' => ['super_admin', 'auditor', 'auditor_internal'],
                ],
                [
        ...
        [
            ...
            'children' => [
                ...
                [
                    ...
                    'roles' => ['super_admin', 'executive', 'admin_pelayanan', 'auditor', 'auditor_internal'],
                ],
                [
